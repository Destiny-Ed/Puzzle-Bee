import 'dart:math';
import 'package:flutter_puzzle/data/point.dart';
import 'package:flutter_puzzle/utils/serializable.dart';
...
class BoardDeserializableFactory extends DeserializableHelper<Board> {
  ...
  Board deserialize(SerializeInput input) {
    ...
    for (var i = 0; i < length; i++) {
      final chip = input.readDeserializable(chipFactory as DeserializableHelper<dynamic>);
      if (chip == null) {
        // return null;
      }

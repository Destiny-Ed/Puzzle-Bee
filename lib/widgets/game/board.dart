...
import 'package:flutter_puzzle/data/chip.dart';
import 'package:flutter_puzzle/domain/game.dart';
import 'package:flutter_puzzle/widgets/game/chip.dart';
...
class _BoardWidgetState extends State<BoardWidget>
  ...
  static double _flingDuration(
      {double friction = _kFriction, double? velocity}) {
    // See mPhysicalCoeff
